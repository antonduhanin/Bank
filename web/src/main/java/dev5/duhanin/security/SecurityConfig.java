...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/users/accounts","/accounts/?/cards", "/cards/?/replenishment/?", "/news/recipient/?", "/transactions/account", "/transactions/card", "users/","/accounts/cards")
                .hasRole("Customer")
                .antMatchers("/cards/state","/accounts/*/*", "/cards/*/*", "/transactions/date", "/users/?/?","/home","/accounts/state","users/cards","users/transactions")
